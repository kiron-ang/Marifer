...
def preprocess_smiles(smiles, tokenizer=None, max_length=18):
    """
    ...
    Args:
        ...
        max_length (int, optional): Maximum length of the SMILES strings. Defaults to 18.
...
def create_lstm_model(vocab_size, embedding_dim=128, lstm_units=256, max_length=18):
    """
    ...
    Args:
        ...
        max_length (int, optional): Maximum length of the input sequences. Defaults to 18.
...
def generate_molecules(model, tokenizer, num_molecules=180, max_length=18):
    """
    ...
    Args:
        ...
        num_molecules (int, optional): Number of molecules to generate. Defaults to 18.
        max_length (int, optional): Maximum length of the generated SMILES strings. Defaults to 18.
